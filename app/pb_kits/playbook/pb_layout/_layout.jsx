...
const Side = (props: LayoutSideProps) => {
  ...
  return (
    <div className={classnames('layout_sidebar', className, systemProps(props))}>
      {children}
    </div>
  )
}
...
const Body = (props: LayoutBodyProps) => {
  const { children, className } = props
  return (
    <div className={classnames('layout_body', className, systemProps(props))}>
      {children}
    </div>
  )
}
...
const Header = (props: LayoutHeaderProps) => {
  const { children, className } = props
  return (
    <div className={classnames('layout_header', className, systemProps(props))}>
      {children}
    </div>
  )
}
...
const Footer = (props: LayoutFooterProps) => {
  const { children, className } = props
  return (
    <div className={classnames('layout_footer', className, systemProps(props))}>
      {children}
    </div>
  )
}
