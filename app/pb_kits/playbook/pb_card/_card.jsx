...
const Header = (props: CardHeaderProps) => {
  ...
  const headerSpacing = systemProps(props) ? systemProps(props) : 'p_sm'
  return (
...
const Body = (props: CardBodyProps) => {
  ...
  const bodySpacing = systemProps(props) ? systemProps(props) : 'p_md'
  return (
...
const Card = (props: CardPropTypes) => {
  ...
  const cardSpacing = systemProps(props) ? systemProps(props) : 'p_md'
