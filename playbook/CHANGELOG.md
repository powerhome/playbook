...
- Dropdown Kit: Quickpick Variant - Rails [\#5624](https://github.com/powerhome/playbook/pull/5624) ([nidaqg](https://github.com/nidaqg))
- Contact Kit: Phone Number Text Only for More Flexible Styling [\#5622](https://github.com/powerhome/playbook/pull/5622) ([kangaree](https://github.com/kangaree))
- Advanced Table: Column Background Color [\#5618](https://github.com/powerhome/playbook/pull/5618) ([nidaqg](https://github.com/nidaqg))
- Dialog Kit: Closeable Prop for Dialog [\#5614](https://github.com/powerhome/playbook/pull/5614) ([nidaqg](https://github.com/nidaqg))
- Timeline Kit: Add Showcurrentyear Prop [\#5609](https://github.com/powerhome/playbook/pull/5609) ([elisashapiro](https://github.com/elisashapiro))
- Table Kit: Variant With Filter [\#5608](https://github.com/powerhome/playbook/pull/5608) ([nidaqg](https://github.com/nidaqg))
...
- Draggable Kit: Fix Cross-container Drag Preview Losing Items [\#5581](https://github.com/powerhome/playbook/pull/5581) ([nidaqg](https://github.com/nidaqg))


[Full Changelog](https://github.com/powerhome/playbook/compare/v15.7.0-rc.3...15.7.0)
...
- Drawer Kit Refactor ([\#4028](https://github.com/powerhome/playbook/pull/4028)) ([@jasperfurniss](https://github.com/jasperfurniss))
- Dark Audit Multiple Users ([\#4139](https://github.com/powerhome/playbook/pull/4139)) ([@yuriyivanenko](https://github.com/yuriyivanenko))
- Rails Input Masking ([\#4127](https://github.com/powerhome/playbook/pull/4127)) ([@markdoeswork](https://github.com/markdoeswork))
- Dark Mode Select ([\#4128](https://github.com/powerhome/playbook/pull/4128)) ([@yuriyivanenko](https://github.com/yuriyivanenko))
- Dark Mode - Map Audit ([\#4154](https://github.com/powerhome/playbook/pull/4154)) ([@gabbymassaro](https://github.com/gabbymassaro))
- SelectableRows for AdvancedTable- React ([\#4131](https://github.com/powerhome/playbook/pull/4131)) ([@nidaqg](https://github.com/nidaqg))
- Selectable Icon - Dark Mode Audit ([\#4140](https://github.com/powerhome/playbook/pull/4140)) ([@gabbymassaro](https://github.com/gabbymassaro))
- Make Date Picker Work within Turbo Frames ([\#4142](https://github.com/powerhome/playbook/pull/4142)) ([@ElisaShapiro](https://github.com/ElisaShapiro))
- Add Expandable/Collapsible Rows to Basic Table Component - RAILS only ([\#4122](https://github.com/powerhome/playbook/pull/4122)) ([@nickamantia](https://github.com/nickamantia))
- DARK MODE AUDIT - Radio (~[\#4133](https://github.com/powerhome/playbook/pull/4133)) ([@cmhorsey](https://github.com/cmhorsey))
- Enable Dark Mode in Loading Inline Text and Labels ([\#4130](https://github.com/powerhome/playbook/pull/4130)) ([@cmhorsey](https://github.com/cmhorsey))
- Convert Kits to Use Pb_content_tag ([\#4106](https://github.com/powerhome/playbook/pull/4106)) ([@ASPhillips8](https://github.com/ASPhillips8))
- Phone Number Input formatAsYouType Prop ([\#4125](https://github.com/powerhome/playbook/pull/4125)) ([@kangaree](https://github.com/kangaree))
- Adding Sticky Right Column and Refactoring PBTable Enhanced Element ([\#4135](https://github.com/powerhome/playbook/pull/4135)) ([@carloslimasd](https://github.com/carloslimasd))
- Draggable Kit: Simplified API for List kit for Rails ([\#4132](https://github.com/powerhome/playbook/pull/4132)) ([@skduncan](https://github.com/skduncan))
- Draggable Kit: Simplified API for SelectableList for Rails ([\#4124](https://github.com/powerhome/playbook/pull/4124)) ([@skduncan](https://github.com/skduncan))
- Advanced Table - Add Table Props to Rails kit ([\#4107](https://github.com/powerhome/playbook/pull/4107)) ([@ElisaShapiro](https://github.com/ElisaShapiro))

**Fixed Bugs:**
- Fix Website Markdown Code Indentation ([\#4137](https://github.com/powerhome/playbook/pull/4137)) ([@cmhorsey](https://github.com/cmhorsey))
- Fix Doc Typos ([\#4136](https://github.com/powerhome/playbook/pull/4136)) ([@yuriyivanenko](https://github.com/yuriyivanenko))
- Fix Timeline Label and Step Spacing ([\#4097](https://github.com/powerhome/playbook/pull/4097)) ([@kangaree](https://github.com/kangaree))
- Scss fixes for Responsive Scroll for Table ([\#4123](https://github.com/powerhome/playbook/pull/4123)) ([@nidaqg](https://github.com/nidaqg))

**Improvements:**
- Typeahead Truncated Text Docs ([\#4152](https://github.com/powerhome/playbook/pull/4152)) ([@yuriyivanenko](https://github.com/yuriyivanenko))
- Update SWIFT_CHANGELOG.md ([\#4138](https://github.com/powerhome/playbook/pull/4138)) ([@jasoncypret](https://github.com/jasoncypret))
- Date Picker Default Date Prop Description Update ([\#4129](https://github.com/powerhome/playbook/pull/4129)) ([@ElisaShapiro](https://github.com/ElisaShapiro))
- Add Brakeman as a Development Dependency in Playbook ([\#4121](https://github.com/powerhome/playbook/pull/4121)) ([@that-jill](https://github.com/that-jill))
- Fix Linting Errors - Typeahead Kit ([\#4091](https://github.com/powerhome/playbook/pull/4091)) ([@Tomm1128](https://github.com/Tomm1128))
- 'Inactive RC' Label: Skip Later Steps ([\#4087](https://github.com/powerhome/playbook/pull/4087)) ([@kangaree](https://github.com/kangaree))

**New Kit:**
- Icon Button Rails - BETA ([\#4141](https://github.com/powerhome/playbook/pull/4141)) ([@markdoeswork](https://github.com/markdoeswork))


[Full Changelog](https://github.com/powerhome/playbook/compare/14.11.1...14.12.0)
...
- Add Tooltip Delay [\#2347](https://github.com/powerhome/playbook/pull/2347) ([augustomallmann](https://github.com/augustomallmann))
...
- Converting Enhanced Element to Typescript [\#2185](https://github.com/powerhome/playbook/pull/2185) ([carloslimasd](https://github.com/carloslimasd))
...
- Reinstated Flatpickr Default AM/PM Toggle [\#2175](https://github.com/powerhome/playbook/pull/2175) ([nidaqg](https://github.com/nidaqg))
...
- \[PLAY-53\]Create partials for visual guideline card sections [\#1718](https://github.com/powerhome/playbook/pull/1718) ([kyleschechter](https://github.com/kyleschechter))
- \[PLAY-47\] Allow rails pb\_title to accept child text [\#1698](https://github.com/powerhome/playbook/pull/1698) ([ns-ian](https://github.com/ns-ian))
- \[GOG-495\] Initial portal config [\#1692](https://github.com/powerhome/playbook/pull/1692) ([TeamTeaTime](https://github.com/TeamTeaTime))

**Kit Enhancements:**

- \[PLAY-32\] Global: Add display props to ALL kits [\#1723](https://github.com/powerhome/playbook/pull/1723) ([nickamantia](https://github.com/nickamantia))
- \[PLAY-42\] Global: Add cursor properties to ALL kits [\#1715](https://github.com/powerhome/playbook/pull/1715) ([RobGentile17](https://github.com/RobGentile17))
- \[PLAY-43\] Add size prop to the button kit [\#1714](https://github.com/powerhome/playbook/pull/1714) ([JelenaD1](https://github.com/JelenaD1))
- Fix Dark Mode on Icon Circle Kit [\#1706](https://github.com/powerhome/playbook/pull/1706) ([pauljpark](https://github.com/pauljpark))
- Added Colors Prop for Gauge Kit & Hex colors available for all Chart kits [\#1699](https://github.com/powerhome/playbook/pull/1699) ([pauljpark](https://github.com/pauljpark))
- \[PLAY-18\] Image kit animations [\#1675](https://github.com/powerhome/playbook/pull/1675) ([diontheroulde](https://github.com/diontheroulde))

**Fixed Bugs:**

- \[PLAY-50\] Fix date time stacked kit spec [\#1707](https://github.com/powerhome/playbook/pull/1707) ([thestephenmarshall](https://github.com/thestephenmarshall))

**Merged pull requests:**

- Update view\_component - clear warning [\#1716](https://github.com/powerhome/playbook/pull/1716) ([xjunior](https://github.com/xjunior))
- Update dependency flow-runtime to v0.17.0 [\#1711](https://github.com/powerhome/playbook/pull/1711) ([renovate[bot]](https://github.com/apps/renovate))
- Update dependency eslint-plugin-flowtype to v4.7.0 [\#1710](https://github.com/powerhome/playbook/pull/1710) ([renovate[bot]](https://github.com/apps/renovate))
- Update dependency copy-webpack-plugin to v6.4.1 [\#1708](https://github.com/powerhome/playbook/pull/1708) ([renovate[bot]](https://github.com/apps/renovate))
- Configure PagerDuty integration in Portal [\#1705](https://github.com/powerhome/playbook/pull/1705) ([benlangfeld](https://github.com/benlangfeld))
- Specify System lifecycle in Portal entity [\#1704](https://github.com/powerhome/playbook/pull/1704) ([benlangfeld](https://github.com/benlangfeld))
- Update dependency @types/react to v17.0.38 [\#1701](https://github.com/powerhome/playbook/pull/1701) ([renovate[bot]](https://github.com/apps/renovate))
- Update dependency es5-shim to v4.6.4 [\#1700](https://github.com/powerhome/playbook/pull/1700) ([renovate[bot]](https://github.com/apps/renovate))
...
- added align self and display flex to flex item [#1678](https://github.com/powerhome/playbook/pull/1678) ([pauljpark](https://github.com/pauljpark))

- Playbook Webpack Cleanup + Simplified Setup [#1672](https://github.com/powerhome/playbook/pull/1672))

- spec and jest tests [#1681](https://github.com/powerhome/playbook/pull/1681) ([kristiflin](https://github.com/kristiflin))

- Add Global Shadow Props to ALL kits ( [#1686](https://github.com/powerhome/playbook/pull/1686) ([pauljpark](https://github.com/pauljpark))

- Add camel case to visual docs props ( ( [#1691](https://github.com/powerhome/playbook/pull/1691) ([batistaDev1113](https://github.com/batistaDev1113))

- Added Custom Color Options for Line Graph Kit ( ( [#1693](https://github.com/powerhome/playbook/pull/1693) ([pauljpark](https://github.com/pauljpark))

- Add Text Color for Caption Kit ( ( [#1685](https://github.com/powerhome/playbook/pull/1685) ([batistaDev1113](https://github.com/batistaDev1113))

- added colors prop, doc example files, and line for spec test ( ( [#1694](https://github.com/powerhome/playbook/pull/1694) ([pauljpark](https://github.com/pauljpark))

- Update dependency rubocop to v1.23.0 ( ( [#1688](https://github.com/powerhome/playbook/pull/1688) renovate)

- Update dependency @testing-library/jest-dom to v5.16.1 ( ( [#1690](https://github.com/powerhome/playbook/pull/1690) renovate)
...
- Rails custom icon [\#1582](https://github.com/powerhome/playbook/pull/1582) ([thestephenmarshall](https://github.com/thestephenmarshall))
- Allow to specify verbiage for selected file types [\#1581](https://github.com/powerhome/playbook/pull/1581) ([gmfvpereira](https://github.com/gmfvpereira))
- Allow all file types by default \[NUXE-897\] [\#1580](https://github.com/powerhome/playbook/pull/1580) ([thestephenmarshall](https://github.com/thestephenmarshall))
- Add input\_options prop to Typeahead + Text Input \[NUXE-644\] [\#1577](https://github.com/powerhome/playbook/pull/1577) ([thestephenmarshall](https://github.com/thestephenmarshall))

**Merged pull requests:**

- Add date kit documentation updates [\#1583](https://github.com/powerhome/playbook/pull/1583) ([thestephenmarshall](https://github.com/thestephenmarshall))
- Update dependency flow-bin to v0.157.0 [\#1578](https://github.com/powerhome/playbook/pull/1578) ([renovate[bot]](https://github.com/apps/renovate))
- Update dependency axe-core to v4.3.2 [\#1570](https://github.com/powerhome/playbook/pull/1570) ([renovate[bot]](https://github.com/apps/renovate))
...
- Security udpate for actionpack, actionview and activesupport [\#1382](https://github.com/powerhome/playbook/pull/1382) ([thestephenmarshall](https://github.com/thestephenmarshall))
