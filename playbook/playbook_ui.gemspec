...
Gem::Specification.new do |s|
  ...
  s.add_dependency "actionpack", ">= 6.1.7.7", ">= 7.0.8"
  s.add_dependency "actionview", ">= 6.1.7.7", ">= 7.0.8"
  s.add_dependency "activesupport", ">= 6.1.7.7", ">= 7.0.8"
  ...
  s.add_development_dependency "rails", ">= 6.1.7.7", ">= 7.0.8"
