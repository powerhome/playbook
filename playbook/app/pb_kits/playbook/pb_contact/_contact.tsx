...
const Contact = (props: ContactProps) => {
  ...
  return (
    <div {...ariaProps} {...dataProps} className={classes} id={id}>
      <Body className="pb_contact_kit" color="light" tag="span">
        <Icon fixedWidth icon={contactTypeMap[contactType] || "phone"} />
        {` ${formatContact(contactValue, contactType)} `}
        {contactDetail && <Caption size="xs" tag="span" text={contactDetail} />}
      </Body>
    </div>
  )
}
