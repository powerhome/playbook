...
export const useHandleOnKeyDown = () => {
    const { autocomplete, filteredOptions, focusedOptionIndex, handleBackspace, handleOptionClick, selected, setFocusedOptionIndex, setIsDropDownClosed, } = useContext(DropdownContext);
    return (e) => {
        ...
        switch (e.key) {
            ...
            case "ArrowUp": {
                e.preventDefault();
                const nextIndexUp = (focusedOptionIndex - 1 + filteredOptions.length) %
