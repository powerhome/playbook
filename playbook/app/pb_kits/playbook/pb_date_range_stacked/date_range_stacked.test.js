...
describe("DateRangeStacked Kit", () => {
  ...
  test("renders arrow icon", () => {
    ...
    const arrowicon = kit.querySelector(
      ".pb_icon_kit.fa-fw.pb_date_range_stacked_arrow"
    )
  ...
  test("renders DateRangeInline start date", () => {
    ...
    const kit = screen.getByTestId(testId)
    const text = kit.querySelector(
      ".pb_date_year_stacked_right>.pb_title_kit_size_4"
    )
  ...
  test("renders DateRangeInline start date year", () => {
    ...
    const kit = screen.getByTestId(testId)
    const text = kit.querySelector(
      ".pb_date_year_stacked_right>.pb_body_kit_light"
    )
  ...
  test("renders DateRangeInline end date", () => {
    ...
    const kit = screen.getByTestId(testId)
    const text = kit.querySelector(
      ".pb_date_year_stacked_left>.pb_title_kit_size_4"
    )
  ...
  test("renders DateRangeInline end date year", () => {
    ...
    const kit = screen.getByTestId(testId)
    const text = kit.querySelector(
      ".pb_date_year_stacked_left>.pb_body_kit_light"
    )
