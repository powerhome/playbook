...
describe("Icon Kit", () => {
  test("renders Icon classname", () => {
    render(<Icon data={{ testid: testId }} fixedWidth icon="user" />)
  ...
  test("renders rotate prop", () => {
    ;["90", "180", "270"].forEach(rotateProp => {
      ...
      expect(kit).toHaveClass(
        `fa-user pb_icon_kit fa-fw fa-rotate-${rotateProp} far`
      )
  ...
  test("renders spinning icon", () => {
    render(<Icon data={{ testid: testId }} fixedWidth icon="spinner" spin />)
  ...
  test("renders border around icon", () => {
    render(<Icon border data={{ testid: testId }} fixedWidth icon="user" />)
  ...
  test("renders size prop", () => {
    ;[
      ...
      render(<Icon data={{ testid: testId }} icon="user" size={sizeProp} />)
  ...
  test("renders fontStyle prop", () => {
    render(
      <Icon data={{ testid: testId }} fixedWidth fontStyle="fas" icon="user" />
    )
