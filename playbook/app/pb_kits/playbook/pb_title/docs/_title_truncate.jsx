...
const TitleTruncate = props => {
  ...
  return (
    <Flex maxWidth="md" orientation="column">
      <Caption text="After first row" {...props} />
      <Title marginBottom="md" size={4} text={lorem} truncate="1" {...props} />

      <Caption text="After second row" {...props} />
      <Title marginBottom="md" size={4} text={lorem} truncate="2" {...props} />

      <Caption text="After third row" {...props} />
      <Title size={4} text={lorem} truncate="3" {...props} />
    </Flex>
  )
}
