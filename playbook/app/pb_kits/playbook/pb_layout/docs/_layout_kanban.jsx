    ...
    <div>
      <Layout layout="kanban">
        <Layout.Body>
          ...
          <Card padding="sm" shadow="deep" {...props}>
            <Flex orientation="row" spacing="between" {...props}>
              <FlexItem>
        ...
        <Layout.Body>
          ...
          <Card padding="sm" shadow="deep">
            ...
            <Flex orientation="row" spacing="between" vertical="bottom">
              <FlexItem marginTop="xs">
                <Avatar
                  imageUrl="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"
                  name="Roger Donahue"
