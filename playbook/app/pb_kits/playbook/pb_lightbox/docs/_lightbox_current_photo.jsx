    ...
    <div className="lightbox_doc_example_custom">
      {light ? (
        <>
          ...
          >
            <Flex margin="lg" orientation="column">
              <Body marginBottom="md">
                This UI is for demonstration purposes only to demonstrate how
                external buttons can be used to change the slides.
              </Body>
        ...
        <div className="PhotoViewer" style={exampleStyles}>
          <Flex>
            {photos.map((photo, index) => {
              return (
                <div key={index} onClick={() => onPhotoClick(index)}>
                  <Image
                    cursor="pointer"
                    marginRight="xl"
                    rounded
