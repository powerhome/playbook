...
test("returns namespaced class name", () => {
  render(<RichTextEditor data={{ testid: testId }} />)
...
test('returns "Simple" namespaced class name via prop', () => {
  render(<RichTextEditor data={{ testid: testId }} simple />)
...
test('returns "Focus" namespaced class name via prop', () => {
  render(<RichTextEditor data={{ testid: testId }} focus />)
...
test('returns "Sticky" namespaced class name via prop', () => {
  render(<RichTextEditor data={{ testid: testId }} sticky />)
...
test('returns "Dark" class name', () => {
  render(<RichTextEditor dark data={{ testid: testId }} />)
