...
const RichTextEditor = (props: RichTextEditorProps) => {
  ...
  if (editor) {
    const toolbarElement = element.parentElement.querySelector(
        "trix-toolbar"
      ) as HTMLElement,
      blockCodeButton = toolbarElement.querySelector(
        "[data-trix-attribute=code]"
      ) as HTMLElement

    let inlineCodeButton = toolbarElement.querySelector(
  ...
  useEffect(() => {
    ...
    element.addEventListener("click", ({ target }: Event) => {
      const trixEditorContainer = (target as Element).closest(
