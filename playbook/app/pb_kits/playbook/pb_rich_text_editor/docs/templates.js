...
export const changelog = `<div>
    <strong>Changelog:<br></strong>[INSERT LINK]<br><br>You can test the normal spots of Playbook rails and react on
    dev docs plus the following:</div>
<div><br></div>`
