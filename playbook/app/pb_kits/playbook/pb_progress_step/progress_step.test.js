  ...
  return (
    <>
      <ProgressStep
        ...
        data={{ testid: testId }}
      >
        <ProgressStepItem data={{ testid: step1Id }} status="complete">
          {"Step 1"}
        </ProgressStepItem>
        <ProgressStepItem data={{ testid: step2Id }} status="active">
          {"Step 2"}
        </ProgressStepItem>
        <ProgressStepItem data={{ testid: step3Id }} status="inactive">
          {"Step 3"}
        </ProgressStepItem>
      </ProgressStep>
    </>
