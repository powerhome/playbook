...
test("adds link to button", () => {
  render(<Button data={{ testid: "link-test" }} link={link} />)
...
test("button with secondary variant", () => {
  render(<Button data={{ testid: "variant-test" }} variant="secondary" />)
...
test("disable prop", () => {
  render(<Button data={{ testid: "disable-test" }} disabled />)
...
test("size prop", () => {
  render(<Button data={{ testid: "size-test" }} size="sm" />)
