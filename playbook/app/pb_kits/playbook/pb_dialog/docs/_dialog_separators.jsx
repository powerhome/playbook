...
const DialogSeparators = () => {
  ...
  const [neitherSeparatorsDialogOpened, toggleNeitherSeparatorsDialog] =
    useDialog()
  ...
  return (
    <div>
      <Flex>
        <Button id="sm" marginRight="xl" onClick={toggleHeaderSeparatorDialog}>
          {"Default"}
        </Button>
        <Button marginRight="xl" onClick={toggleFooterSeparatorDialog}>
          {"Footer Separator"}
        </Button>
        <Button marginRight="xl" onClick={toggleBothSeparatorsDialog}>
          {"Both Separators"}
        </Button>
        <Button marginRight="xl" onClick={toggleNeitherSeparatorsDialog}>
          {"No Separators"}
        </Button>
      </Flex>
      <Flex>
        {dialogs.map(dialog => (
          <Dialog key={dialog.size} opened={dialog.visible} size={dialog.size}>
