...
const SelectableListCheckbox = () => {
  return (
    <SelectableList data={{ testid: testId }} variant="checkbox">
      <SelectableList.Item label="Mild" name="checkbox-name-1" value="1" />
      <SelectableList.Item
        checked
        label="Medium"
...
const SelectableListRadio = () => {
  return (
    <SelectableList data={{ testid: testId }} variant="radio">
      <SelectableList.Item label="Small" name="radio" value="1" />
      <SelectableList.Item
        defaultChecked
        label="Medium"
        name="radio"
