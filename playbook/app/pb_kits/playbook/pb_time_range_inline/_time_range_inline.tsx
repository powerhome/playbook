...
const dateTimestamp = (dateValue: Date) => {
  return `${DateTime.toHour(dateValue)}:${DateTime.toMinute(
    dateValue
  )}${DateTime.toMeridiem(dateValue)}`
}
  ...
  return (
    <div
      ...
      className={classnames(
        "pb_time_range_inline_kit_" + alignment,
        globalProps(props),
        className
      )}
      id={id}
      ...
      <div className="pb_time_range_inline_wrapper">
        ...
        {size == "sm" && (
          <>
            ...
            <Body className="pb_time_range_inline_arrow" dark={dark} tag="span">
              {separator}
            </Body>
            <Body dark={dark} tag="span">
              <time dateTime={dateTimeIso(endTime)}>
