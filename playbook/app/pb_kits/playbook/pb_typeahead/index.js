...
export default class PbTypeahead extends PbEnhancedElement {
    ...
    get debouncedSearch() {
        return this._debouncedSearch = (this._debouncedSearch ||
            debounce(this.search, parseInt(this.searchDebounceTimeout)).bind(this));
    }
    showResults() {
        if (!this.resultsOptionCache.has(this.searchTermAndContext))
            return;
    ...
    focusPreviousOption() {
        ...
        const previousOptionItem = (this.resultOptionItems[previousIndex] ||
    ...
    focusNextOption() {
        ...
        const nextOptionItem = (this.resultOptionItems[nextIndex] ||
    ...
    get searchContext() {
        ...
        if (selector)
            return (this.element.parentNode.querySelector(selector) ||
                this.element.closest(selector)).value;
        return null;
    }
    ...
    get resultOptionTemplate() {
        return this._resultOptionTemplate = (this._resultOptionTemplate ||
            this.element.querySelector('template[data-pb-typeahead-kit-result-option]'));
    }
    get resultsOptionCache() {
        return this._resultsOptionCache = (this._resultsOptionCache ||
            new Map);
    }
    get resultsLoadingIndicator() {
        return this._resultsLoadingIndicator = (this._resultsLoadingIndicator ||
