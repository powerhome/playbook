...
export type BackgroundColors = 'bg_light' | 'bg_dark' | 'bg_dark_card'
...
export type Colors = ProductColors & StatusColors & DataColors & ShadowColors &
    InterfaceColors & MainColors & BackgroundColors & CardColors & ActiveColors &
    ActionColors & HoverColors & BorderColors & TextColors & CategoryColors &
    BaseColors & FocusInputColors & StatusTextColors