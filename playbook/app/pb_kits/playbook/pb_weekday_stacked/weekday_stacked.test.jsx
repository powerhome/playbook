...
describe("WeekdayStacked Kit", () => {
  test("renders className", () => {
    render(<WeekdayStacked data={{ testid: testId }} />)
  ...
  test("renders compact prop", () => {
    render(<WeekdayStacked compact data={{ testid: testId }} />)
  ...
  test("renders align prop", () => {
    render(<WeekdayStacked align="left" data={{ testid: testId }} />)
  ...
  test("renders day_only variant prop", () => {
    render(<WeekdayStacked data={{ testid: testId }} variant="day_only" />)
  ...
  test("renders expanded variant prop", () => {
    render(<WeekdayStacked data={{ testid: testId }} variant="expanded" />)
