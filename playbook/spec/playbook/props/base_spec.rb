...
RSpec.describe Playbook::Props::Base do
  describe "#validate!" do
    ...
    it "raises error when child class fails validation" do
      ...
      expect { falsy_validation_class.new(name: :test_prop, kit: falsy_validation_class).validate!("wrong_value") }.to(
        raise_error(Playbook::Props::Error,
                    /#<Class:.*> has invalid value of '"wrong_value"' for prop 'test_prop'/)
      )
    end
  end
end
