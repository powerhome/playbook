...
RSpec.describe Playbook::PbFlex::Flex do
  ...
  it { is_expected.to define_enum_prop(:justify)
                      .with_default("none")
  ...
  it { is_expected.to define_enum_prop(:gap)
                      .with_default("none")
                      .with_values("xs", "sm", "md", "lg", "xl", "none") }
  it { is_expected.to define_enum_prop(:row_gap)
                      .with_default("none")
                      .with_values("xs", "sm", "md", "lg", "xl", "none") }
  it { is_expected.to define_enum_prop(:column_gap)
                      .with_default("none")
                      .with_values("xs", "sm", "md", "lg", "xl", "none") }
