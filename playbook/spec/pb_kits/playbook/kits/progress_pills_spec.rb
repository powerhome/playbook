...
RSpec.describe Playbook::PbProgressPills::ProgressPills do
  ...
  it {
    is_expected.to define_prop(:steps)
      .of_type(Playbook::Props::Number)
      .with_default(3)
  }
  it {
    is_expected.to define_prop(:active)
      .of_type(Playbook::Props::Number)
      .with_default(0)
  }
  it {
    is_expected.to define_prop(:title)
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      ...
      expect(subject.new({ dark: true }).classname).to eq "pb_progress_pills_kit dark"
    end
  end
end
