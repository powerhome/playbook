...
RSpec.describe Playbook::PbUser::User do
  ...
  it {
    is_expected.to define_boolean_prop(:avatar)
      .with_default(false)
  }
  it { is_expected.to define_prop(:avatar_url) }
  it { is_expected.to define_prop(:name) }
  it { is_expected.to define_enum_prop(:name_style).with_default("title").with_values("title", "body", "caption", "detail") }
  it {
  ...
  it { is_expected.to define_enum_prop(:title_style).with_default("body").with_values("body", "caption", "detail") }
