...
RSpec.describe Playbook::PbProgressStep::ProgressStepItem do
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      ...
      expect(subject.new(status: 'hidden').classname).to eq "pb_progress_step_item_hidden"
      ...
      expect(subject.new(status: 'hidden', classname: "additional_class").classname).to eq "pb_progress_step_item_hidden additional_class"
