...
RSpec.describe Playbook::PbCard::Card do
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      ...
      expect(subject.new(shadow: "deeper").classname).to eq "pb_card_kit_deselected border_radius_md shadow_deeper"
      expect(subject.new(selected: true, shadow: "deep").classname).to eq "pb_card_kit_selected border_radius_md shadow_deep"
