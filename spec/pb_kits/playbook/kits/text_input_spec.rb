...
RSpec.describe Playbook::PbTextInput::TextInput do
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      ...
      expect(subject.new({error: "Please enter a valid email"}).classname).to eq "pb_text_input_kit_error"
      expect(subject.new({dark: true, error: "Please enter a valid email"}).classname).to eq "pb_text_input_kit_dark_error"
    end
  end
end
