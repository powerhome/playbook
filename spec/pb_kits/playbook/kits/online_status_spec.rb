...
RSpec.describe Playbook::PbOnlineStatus::OnlineStatus do
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      expect(subject.new({}).classname).to eq "pb_online_status_kit"
      expect(subject.new(classname: "additional_class").classname).to eq "pb_online_status_kit additional_class"
    end
  end
end
