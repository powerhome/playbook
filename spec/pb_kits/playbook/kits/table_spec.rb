...
RSpec.describe Playbook::PbTable::Table do
  ...
  describe "#classname" do
    it "returns namespaced class name", :aggregate_failures do
      ...
      expect(subject.new(dark: true).classname).to eq "pb_table table-md table-dark table-card table-responsive-collapse dark"
      ...
      expect(subject.new(disable_hover: true, dark: true, size: "lg", single_line: true).classname).to eq "pb_table table-lg single-line table-dark no-hover table-card table-responsive-collapse dark"
    end
  end
end
