...
window.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('#code-wrapper').forEach(function (wrapper) {
    var openToggle = wrapper.querySelector('#toggle-open');
    var closeToggle = wrapper.querySelector('#toggle-close');
...
},[["./app/javascript/packs/site.js","runtime","vendors~application~react_sidebar~samples~site~visual_guidelines","vendors~site"]]]);
//# sourceMappingURL=site-1506262eb1d0c11e5196.chunk.js.map