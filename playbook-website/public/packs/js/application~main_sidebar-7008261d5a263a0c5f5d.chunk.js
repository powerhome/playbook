...
var KitsNavItem = function KitsNavItem(_ref) {
  ...
  var handleSubItemClick = function handleSubItemClick(i, sublink) {
    ...
    onChildClick(); // call the callback function to keep parent nav state open
  };
...
var TopLevelNavItem = function TopLevelNavItem(_ref) {
  ...
  var renderTopItems = function renderTopItems(name, key, children, leftIcon, link, i) {
    ...
    var handleChildComponentClick = function handleChildComponentClick() {
      console.log("onCurrentPage() page truthy or falsy????", onCurrentPage());
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(playbook_ui__WEBPACK_IMPORTED_MODULE_1__["NavItem"], {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_NavComponents_KitsNavComponent__WEBPACK_IMPORTED_MODULE_2__["KitsNavItem"], {
        onChildClick: onCurrentPage() ? function () {} : handleChildComponentClick,
        link: link,
        i: i,
        ...
        dark: dark,
        kit: kit,
        onMainClick: handleChildComponentClick,
        isActive: isActive,
...
//# sourceMappingURL=application~main_sidebar-7008261d5a263a0c5f5d.chunk.js.map