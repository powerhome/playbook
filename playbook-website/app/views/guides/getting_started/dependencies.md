...
**Chart Kits**: PbBarGraph, PbCircleChart, PbGaugeChart, and PbLineGraph are available through a separate entrypoint to keep Highcharts optional. Import them using:
```javascript
