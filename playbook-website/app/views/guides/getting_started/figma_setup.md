...
Playbook uses [Playbook Icons](/icons) for its icon library. In Figma, icons come from the Playbook design library. In product code, use Playbook Icons (or optionally Font Awesome if your app already provides it). See [Dependencies](/guides/getting_started/dependencies) for install details.

### Updates

The Playbook team periodically updates the library. Check back on the [library page](https://www.figma.com/community/file/1320084191991515570/playbook-design-system) in Figma to see our change log and make sure to keep your files updated.
