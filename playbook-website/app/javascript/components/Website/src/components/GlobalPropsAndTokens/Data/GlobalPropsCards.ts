export const GlobalPropsCards = [
  ...
  },
  {
    title: "Truncate",
    description:
      "Shortens text to fit within a container, adding ellipsis to the end to indicate truncated content.",
    icon: "ellipsis",
  ...
  },
  {
    title: "Border",
    description:
      "Applies specific border styles to all sides, individual sides, or horizontal and vertical axes.",
    icon: "border-all",
    link: "/global_props/border",
  }
];
