...
export async function barGraphCode() {
    const url = "https://raw.githubusercontent.com/powerhome/playbook/master/playbook/app/pb_kits/playbook/pb_bar_graph/_bar_graph.tsx";
    return await kitCode(url);
}
