        ...
        <PropsExamplesTable
          ...
          rows={[
            [
              ...
              <ExampleCodeCard id="width-rails" text="width: '0'" />,
              <ExampleCodeCard id="width-react" text="width= 'xs'" />,
            ],
            [
              "360px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xs" tooltipText="360px"/></Flex>,
              <ExampleCodeCard id="width-rails" text="width: 'xs'" />,
              <ExampleCodeCard id="width-react" text="width= 'xs'" />,
            ],
            [
              "540px",
              ...
              <ExampleCodeCard id="width-rails" text="width: 'sm'" />,
              <ExampleCodeCard id="width-react" text="width= 'sm'" />,
            ],
            [
              "720px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="md" tooltipText="720px"/></Flex>,
              <ExampleCodeCard id="width-rails" text="width: 'md" />,
              <ExampleCodeCard id="width-react" text="width= 'md'" />,
            ],
            [
              "960px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="lg" tooltipText="360px"/></Flex>,
              <ExampleCodeCard id="width-rails" text="width: 'lg'" />,
              <ExampleCodeCard id="width-react" text="width= 'lg'" />,
            ],
            [
              "1140px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xl" tooltipText="1140px"/></Flex>,
              <ExampleCodeCard id="width-rails" text="width: 'xl'" />,
              <ExampleCodeCard id="width-react" text="width= 'xl'" />,
            ],
            [
              "1320px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xxl" tooltipText="1320px"/></Flex>,
              <ExampleCodeCard id="width-rails" text="width: 'xxl'" />,
              <ExampleCodeCard id="width-react" text="width= 'xxl'" />,
            ],
            [
              "100%",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ExampleCodeCard text="100%" copyIcon={false} /></Flex>,
              <ExampleCodeCard id="width-rails" text="width: '100%'" />,
              <ExampleCodeCard id="width-react" text="width= '100%'" />,
            ],
          ]}
        />
      </ShowPage>
