        ...
        <PropsExamplesTable
          ...
          rows={[
            [
              ...
              <ExampleCodeCard id="min-width-rails" text="min_width: 'xs'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'xs'" />,
            ],
            [
              "540px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="sm" tooltipText="540px"/></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: 'sm'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'sm'" />,
            ],
            [
              "720px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="md" tooltipText="720px"/></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: 'md" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'md'" />,
            ],
            [
              "960px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="lg" tooltipText="360px"/></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: 'lg'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'lg'" />,
            ],
            [
              "1140px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xl" tooltipText="1140px"/></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: 'xl'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'xl'" />,
            ],
            [
              "1320px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xxl" tooltipText="1320px"/></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: 'xxl'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= 'xxl'" />,
            ],
            [
              "100%",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ExampleCodeCard text="100%" copyIcon={false} /></Flex>,
              <ExampleCodeCard id="min-width-rails" text="min_width: '100%'" />,
              <ExampleCodeCard id="min-width-react" text="minWidth= '100%'" />,
            ],
          ]}
        />
      </ShowPage>
