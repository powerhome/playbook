        ...
        <PropsExamplesTable
          ...
          rows={[
            [
              ...
              <ExampleCodeCard id="max-width-xs-rails" text='max_width: "xs"' />,
              <ExampleCodeCard id="max-width-xs-react" text='maxWidth="xs"' />,
            ],
            [
              "540px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="sm" tooltipText="540px"/></Flex>,
              <ExampleCodeCard id="max-width-sm-rails" text='max_width: "sm"' />,
              <ExampleCodeCard id="max-width-sm-react" text='maxWidth="sm"' />,
            ],
            [
              "720px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="md" tooltipText="720px"/></Flex>,
              <ExampleCodeCard id="max-width-md-rails" text='max_width: "md"' />,
              <ExampleCodeCard id="max-width-md-react" text='maxWidth="md"' />,
            ],
            [
              "960px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="lg" tooltipText="360px"/></Flex>,
              <ExampleCodeCard id="max-width-lg-rails" text='max_width: "lg"' />,
              <ExampleCodeCard id="max-width-lg-react" text='maxWidth="lg"' />,
            ],
            [
              "1140px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xl" tooltipText="1140px"/></Flex>,
              <ExampleCodeCard id="max-width-xl-rails" text='max_width: "xl"' />,
              <ExampleCodeCard id="max-width-xl-react" text='maxWidth="xl"' />,
            ],
            [
              "1320px",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ValueCardWithTooltip text="xxl" tooltipText="1320px"/></Flex>,
              <ExampleCodeCard id="max-width-xxl-rails" text='max_width: "xxl"' />,
              <ExampleCodeCard id="max-width-xxl-react" text='maxWidth="xxl"' />,
            ],
            [
              "100%",
              <ExampleCodeCard text="string" copyIcon={false} />,
              <Flex gap="xs" wrap><ExampleCodeCard text="100%" copyIcon={false} /></Flex>,
              <ExampleCodeCard id="max-width-100-rails" text='max_width: "100%"' />,
              <ExampleCodeCard id="max-width-100-react" text='maxWidth="100%"' />,
            ],
          ]}
        />
      </ShowPage>
