const SantaFrog = () => {
  ...
  return (
    <div className="santa-frogs-container">
      <span className="santa-frog santa-frog-1"><SantaFrogSVG /></span>
      <span className="santa-frog santa-frog-2"><SantaFrogSVG /></span>
      <span className="santa-frog santa-frog-3"><SantaFrogSVG /></span>
      <span className="santa-frog santa-frog-4"><SantaFrogSVG /></span>
      <span className="santa-frog santa-frog-5"><SantaFrogSVG /></span>
    </div>
  );
};
